                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name') }}" required placeholder="Contoh: Ruang Server">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <select name="level" class="form-select @error('level') is-invalid @enderror" required>
                                    ...
                                    <option value="building" {{ old('level') == 'building' ? 'selected' : '' }}>Gedung
                                    </option>
                                    <option value="floor" {{ old('level') == 'floor' ? 'selected' : '' }}>Lantai</option>
                                    <option value="room" {{ old('level') == 'room' ? 'selected' : '' }}>Ruangan</option>
                                    <option value="other" {{ old('level') == 'other' ? 'selected' : '' }}>Lainnya</option>
                                </select>
                                @error('level')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="address" class="form-control @error('address') is-invalid @enderror"
                                    rows="3" placeholder="Alamat lengkap lokasi">{{ old('address') }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="building"
                                    ...
                                    value="{{ old('building') }}" placeholder="Contoh: Gedung A">
                                @error('building')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="floor" class="form-control @error('floor') is-invalid @enderror"
                                    value="{{ old('floor') }}" placeholder="Contoh: Lantai 2">
                                @error('floor')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="room" class="form-control @error('room') is-invalid @enderror"
                                    value="{{ old('room') }}" placeholder="Contoh: R.201">
                                @error('room')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
